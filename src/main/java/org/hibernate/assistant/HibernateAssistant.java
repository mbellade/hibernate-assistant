...
public interface HibernateAssistant {
	/**
	 * Creates an {@link AiQuery} by providing the specified natural language {@code message} to the LLM
	 * and interpreting the obtained response.
	 *
	 * @param message the natural language prompt
	 * @param session Hibernate session
	 *
	 * @return the {@link AiQuery} generated by the LLM
	 */
	default AiQuery<?> createAiQuery(String message, Session session) {
	 ...
	 * @return the {@link AiQuery} generated by the LLM
	 */
	<T> AiQuery<T> createAiQuery(String message, Session session, Class<T> resultType);
	 ...
	 * a natural language response by passing the resulting data back to the underlying LLM.
	 * <p>
